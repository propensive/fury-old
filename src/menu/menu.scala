...
object FuryMenu {
  ...
  def menu(aliases: List[Action[Cli[CliParam[_]]]]): Menu[Cli[CliParam[_]], _] =
    Menu('main, "main menu", (x: Cli[CliParam[_]]) => Success(x), 'build)(List(
        ...
        Menu('alias, msg"view and edit command aliases", (m: Cli[CliParam[_]]) => Try(m), 'list)(
        ...
        Menu('binary, msg"manage binary dependencies for the module", BinaryCli.mkContext, 'list)(
        ...
        Menu('build, msg"perform build actions", BuildCli.mkContext, 'compile)(
        ...
        Menu('clean, msg"clean fury workspace", CleanCli.mkContext, 'all)(
        ...
        Menu('config, msg"change system configuration options", ConfigCli.mkContext, 'set)(
            Action('set, msg"change a settings", ConfigCli.set)
        ),
        Menu('dependency, msg"manage dependencies for the module", DependencyCli.mkContext, 'list)(
        ...
        Menu('module, msg"view and edit modules", ModuleCli.mkContext, 'list)(
        ...
        Menu('param, msg"manage compiler parameters for the module", ParamCli.mkContext, 'list)(
        ...
        Menu('source, msg"manage sources for the module", SourceCli.mkContext, 'list)(
        ...
        Menu('schema, msg"manage the current schema", SchemaCli.mkContext, 'list)(
        ...
        Menu('repo, msg"manage source repositories for the schema", RepoCli.mkContext, 'list)(
        ...
        Menu('layer, msg"view and edit the layer", (t: Cli[CliParam[_]]) => Try(t), 'projects)(
            ...
            Action('select, msg"select the current layer", LayerCli.select)
        )
    ) ::: aliases: _*)
