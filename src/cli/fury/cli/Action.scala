...
/**
  ...
  */
class Action[+A <: Parameter[_], +B](val parameters: Parameters[A])(f: Bindings[A] => Try[B]) {
...
private[cli] object Action {
  ...
  final class Completed[A](value: A) extends Action[Nothing, A](Parameters.empty)(_ => Try(value))
}
