...
object Args {
  ...
  val DependencyArg = CliParam[String]('d', 'dependency, "specify a dependency on another module")
  val SourceArg = CliParam[String]('f', 'source, "specify a source directory")
