...
const $s_Lfrontend_app_Main__main__AT__V = (function(args) {
  const this$3 = $m_s_Console$();
  const this$4 = $as_Ljava_io_PrintStream(this$3.s_Console$__f_outVar.s_util_DynamicVariable__f_v);
  this$4.java$lang$JSConsoleBasedPrintStream$$printString__T__V("testMethod run\n")
});
...
$L0 = new $c_RTLong(0, 0);
$s_Lfrontend_app_Main__main__AT__V($makeNativeArrayWrapper($d_T.getArrayOf(), []));
}).call(this);
